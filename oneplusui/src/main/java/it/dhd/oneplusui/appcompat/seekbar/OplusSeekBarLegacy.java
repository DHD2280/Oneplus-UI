 ...
 */
public class OplusSeekBarLegacy extends AbsSeekBar implements AnimationListener, AnimationUpdateListener {
    ...
    public OplusSeekBarLegacy(Context context) {
        this(context, null);
    }

    public OplusSeekBarLegacy(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R.attr.oplusSeekBarLegacyStyle);
    }

    public OplusSeekBarLegacy(Context context, AttributeSet attributeSet, int defStyleAttr) {
        this(context, attributeSet, defStyleAttr, R.style.Widget_Oplus_SeekBarLegacy);
    }

    public OplusSeekBarLegacy(Context context, AttributeSet attributeSet, int defStyleAttr, int defStyleRes) {
    ...
    public interface OnSeekBarChangeListener {
        void onProgressChanged(OplusSeekBarLegacy oplusSeekbar, int progress, boolean fromUser);

        void onStartTrackingTouch(OplusSeekBarLegacy oplusSeekbar);

        void onStopTrackingTouch(OplusSeekBarLegacy oplusSeekbar);
    }
    ...
    public final class PatternExploreByTouchHelper extends ExploreByTouchHelper {
        ...
        public void onPopulateNodeForVirtualView(int virtualViewId, @NonNull AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(OplusSeekBarLegacy.class.getName());

...
//        dispatchOnChangedProgrammatically();
    ...
    private Float calculateIncrementForKey(int keyCode) {
        ...
        float increment = isLongPress ? calculateStepIncrement(DAMPING_DISTANCE) : calculateStepIncrement();
        ...
        protected boolean onPerformActionForVirtualView(
            ...
            switch (action) {
                ...
                case AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD: {
                    float increment = slider.calculateStepIncrement(DAMPING_DISTANCE);
